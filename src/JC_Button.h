...
class Button
{
    public:
        ...
        Button(uint8_t pin, uint32_t dbTime=25, uint8_t m_pMode=INPUT_PULLUP, uint8_t invert=true)
            : m_pin(pin), m_dbTime(dbTime), m_pMode(m_pMode), m_invert(invert) {}
    ...
    private:
        ...
        uint8_t m_pMode;        // internal pullup resistor enabled
